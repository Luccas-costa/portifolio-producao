...
export default function ButtonSlider({ chosen }: { chosen: boolean }) {
  return (
    <>
      {chosen ? (
        <Link
          href="/contact?goingTo=contact"
          className={`${styles.button2} relative flex h-[50px] cursor-pointer select-none items-center overflow-hidden rounded-[48px] bg-white/80 pl-[20px] pr-[60px] text-xl text-[#08081E] shadow-[inset_0_0_1.6em_-0.6em_#714da6]`}
        >
          Contate-me
