  ...
  return (
    <div className="fixed left-1/2 top-1/2 flex h-[160px] max-h-14 w-[900px] -translate-x-1/2 -translate-y-[70%] items-center justify-center gap-0 overflow-hidden font-montserrat text-[50px] font-black text-zinc-200 screen450:max-h-20 screen450:text-[80px] screen700:max-h-32 screen700:text-[120px] screen900:max-h-36 screen900:text-[160px]">
      ...
      >
        ...
        <div className="translate-y-[-66px] screen450:translate-y-[-87px] screen700:translate-y-[-135px] screen900:translate-y-[-200px]">
          C
        </div>
        <div className="translate-y-[-92px] screen450:translate-y-[-134px] screen700:translate-y-[-205px] screen900:translate-y-[-280px]">
          C
        </div>
        <div className="translate-y-[-114px] screen450:translate-y-[-180px] screen700:translate-y-[-275px] screen900:translate-y-[-360px]">
          C
        </div>
      </motion.div>
