...
"
        />
        <div className="py-2 text-4xl">Ferramentas Poderosas</div>
...
"
        />
        <div className="py-2 text-xl">Ferramentas Poderosas</div>
...
"
        />
        <div className="py-4 text-5xl">Ferramentas Poderosas</div>
